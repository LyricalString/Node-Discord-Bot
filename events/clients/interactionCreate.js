        ...
        await fetchGuild(this.client, guild).then(async (results, err) => {
            ...
            if (interaction.commandName == 'Avatar') {
                        ...
                        case 'automod':
                            switch (interaction.options._subcommand) {
                                ...
                                case 'antiflood':
                                    ...
                                    s.config.FloodDetection.Filter.Messages =
                                        interaction.options._hoistedOptions[0].value
                                    s.config.FloodDetection.Filter.Seconds =
                                        interaction.options._hoistedOptions[1].value
                                    guild.config.FloodDetection.Filter.Messages =
                                        interaction.options._hoistedOptions[0].value
                                        ...
                                        case 'antiflood':
                                            if (!s.config.FloodDetection.Filter)
                                                return interaction.reply({
                                                    content:
                                                        'Antes de ajustar los parámetros del antiflood debes de personalizar el filtro en `/config automod antiflood`.',
                                                    ephemeral: true
                                                })
                                            s.config.FloodDetection.Action.Todo =
                                                interaction.options._hoistedOptions[1].value
                                        ...
                                        return this.client.api
                                            ...
                                            .callback.post({
                                                data: {
                                                    ...
                                                    data: {
                                                        content:
                                                            'El canal seleccionado no es válido. Debes de seleccionar un canal de voz.',
                                                        flags: 64
                                                    }
                                                }
                                            })
                                        ...
                                        return this.client.api
                                            ...
                                            .callback.post({
                                                data: {
                                                    ...
                                                    data: {
                                                        content:
                                                            'La categoría seleccionada no es válida. Debes de seleccionar una categoría.',
                                                        flags: 64
                                                    }
                                                }
                                            })
                                        ...
                                        return this.client.api
                                            ...
                                            .callback.post({
                                                data: {
                                                    ...
                                                    data: {
                                                        content:
                                                            'Has habilitado los comandos al límite de los términos de conducta de Discord.',
                                                        flags: 64
                                                    }
                                                }
                                            })
                                        ...
                                        return this.client.api
                                            ...
                                            .callback.post({
                                                data: {
                                                    ...
                                                    data: {
                                                        content:
                                                            'Has deshabilitado los comandos al límite de los términos de conducta de Discord.',
                                                        flags: 64
                                                    }
                                                }
                                            })
                ...
                await interaction.reply({
                    content: this.client.language.FNPROFILE[11]
                })
                limiter
                    .schedule(async () => {
                        return axios({
